...
//import { AvisoTableMenu } from './AvisoTableMenu';
...
function AvisoPage(){
  ...
  const encabezados = [
    [
  { id: 1, label: "", ordenBy: "", orden: "", showFilter: false, width: 150 },
  { id: 2, label: "Nombre", ordenBy: "nombre", orden: "desc", showFilter: true },
  { id: 3, label: "Fecha inicio", ordenBy: "fecha_inicio", orden: "desc", showFilter: true },
  { id: 4, label: "Descripción", ordenBy: "descripcion", orden: "desc", showFilter: true },
  { id: 5, label: "Estado", ordenBy: "status", orden: "desc", showFilter: true },
  { id: 6, label: "", ordenBy: "", orden: "", showFilter: false }
]
  ...
  async function buscar() {
    ...
    try{
      //Ejecutamos busqueda
      var res = await avisoService.buscar(palabra, ordenBy, orden, pagina);
  ...
  function handleAgregar(e){
    ...
    navigate(ConstantsRoutes.SPA_AVISO_AGREGAR, { replace: true });
  }
                  ...
                  <TableBody>
                    ...
                    {list.map((row, index) => (
                      ...
                      <Grow in={!loading} timeout={(index*250) + 250}>
                        <TableRow key={row.Aviso_id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }} hover>
