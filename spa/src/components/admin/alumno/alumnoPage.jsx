...
import { AlumnoTableMenu } from './alumnoTableMenu';
...
function AlumnoPage(){
  ...
  async function buscar() {
    ...
    try{
      //Ejecutamos busqueda
      var res = await alumnoService.buscar(palabra, ordenBy, orden, pagina);
  ...
  function handleAgregar(e){
    ...
    navigate(ConstantsRoutes.SPA_ALUMNO_AGREGAR, { replace: true });
  }
                      ...
                      <Grow in={!loading} timeout={(index*250) + 250}>
                        <TableRow key={row.maestro_id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }} hover>
                          ...
                          <TableCell>
                            ...
                            <AlumnoTableMenu alumno={row} setLoadingModal={setLoadingModal} onComplete={resetBusqueda}/>
                          </TableCell>
                        </TableRow>
                      </Grow>
                    ))}
